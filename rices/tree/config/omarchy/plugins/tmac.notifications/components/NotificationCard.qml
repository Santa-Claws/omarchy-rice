...
BorderSurface {
  ...
  readonly property var cardBorderSpec: Border.surfaceSpec("notifications", "border", Color.notifications.border, Math.max(1, Style.space(2) * sizeScale))
  ...
  implicitWidth: Style.space(380) * sizeScale
  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      Layout.leftMargin: Style.space(12) * root.sizeScale
      Layout.rightMargin: Style.space(12) * root.sizeScale
      Layout.topMargin: (root.singleLineToast ? Style.space(7) : Style.space(10)) * root.sizeScale
      Layout.bottomMargin: (root.singleLineToast ? Style.space(7) : Style.space(10)) * root.sizeScale
      spacing: root.collapseRedundantIcon ? 0 : (root.compactGlyph ? Style.space(8) : Style.space(12)) * root.sizeScale

      Item {
        id: smallIconSlot
        Layout.preferredWidth: visible ? Style.space(40) * root.sizeScale : 0
        Layout.preferredHeight: visible ? Style.space(40) * root.sizeScale : 0
        ...
        Text {
          ...
          font.pixelSize: Style.font.displayLarge * root.sizeScale
        }
      }
      ...
      Text {
        ...
        color: Color.notifications.text
        font.family: root.fontFamily
        font.pixelSize: Style.font.icon * root.sizeScale
      }

      ColumnLayout {
        Layout.fillWidth: true
        Layout.alignment: Qt.AlignVCenter
        spacing: Style.space(2) * root.sizeScale
        ...
        Text {
          ...
          color: Color.notifications.text
          font.pixelSize: Style.font.title * root.sizeScale
          font.bold: true
        ...
        Text {
          Layout.fillWidth: true
          Layout.topMargin: Style.space(2) * root.sizeScale
